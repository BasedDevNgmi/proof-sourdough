        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <h1 className="font-[family-name:var(--font-playfair)] text-2xl font-semibold tracking-tight text-stone-100 mt-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-2 text-stone-500 active:text-stone-300"
              >
                <Edit3 size={16} />
              </button>
              <button
                type="button"
                onClick={deleteBake}
                className="p-2 text-stone-600 active:text-rose-400"
              >
                <Trash2 size={16} />
              </button>
            </div>
          ...
          {recipe && (
            <Link
              href={`/bake/${recipe.id}`}
              className="inline-flex items-center gap-1.5 mt-3 text-xs text-amber-500 font-medium"
            >
        ...
        {editing ? (
          ...
          >
            ...
            <button
              type="button"
              onClick={saveEdits}
              className="w-full bg-amber-500 text-stone-950 font-semibold text-sm py-2.5 rounded-xl flex items-center justify-center gap-2"
            >
