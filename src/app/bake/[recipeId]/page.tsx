    ...
    <div className="min-h-screen bg-stone-950 flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 pt-14 pb-3">
        <button
          type="button"
          onClick={() => router.push("/")}
          className="text-stone-500 active:text-stone-300 transition-colors p-1"
        >
          <ArrowLeft size={20} />
        </button>
        ...
        <button
          ...
          className="text-xs text-amber-500 font-medium px-2 py-1 active:text-amber-400"
        >
          Finish
        </button>
      </div>
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="font-[family-name:var(--font-playfair)] text-xl font-semibold text-stone-100">
                  {step.title}
                </h2>
              </div>
              {step.duration && (
      ...
      <div className="px-5 py-4 pb-safe flex items-center gap-3">
        <button
          ...
          className="w-12 h-12 rounded-xl bg-stone-800 flex items-center justify-center disabled:opacity-30 active:bg-stone-700 transition-colors"
        >
        ...
        {!completedSteps.has(currentStep) ? (
          <button
            ...
            className="flex-1 h-12 bg-amber-500 text-stone-950 font-semibold text-sm rounded-xl flex items-center justify-center gap-2 active:bg-amber-600 transition-colors"
          >
            <Check size={16} />
          ...
          <button
            ...
            className="flex-1 h-12 bg-stone-800 text-stone-300 font-medium text-sm rounded-xl flex items-center justify-center gap-2 active:bg-stone-700 transition-colors"
          >
        ...
        {showFinishModal && (
          ...
          >
            <motion.div
              ...
              className="w-full bg-stone-900 rounded-t-3xl max-h-[85vh] overflow-y-auto"
            >
              ...
              <div className="px-5 py-4 space-y-5">
                ...
                <div className="space-y-2 pb-safe">
                  <button
                    ...
                    onClick={finishBake}
                    disabled={saving}
                    className="w-full bg-amber-500 text-stone-950 font-semibold text-sm py-3 rounded-xl flex items-center justify-center gap-2 active:bg-amber-600 transition-colors disabled:opacity-50"
                  >
                    <Save size={16} />
